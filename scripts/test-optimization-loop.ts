...
import { MutationManager } from '../src/safety-gates/mutation-manager';
...
import { CommentEvent, AttentionState } from '../src/types';
...
async function testOptimizationLoop() {
  ...
  let iteration = 0;
  let previousAttention: AttentionState | null = null;
